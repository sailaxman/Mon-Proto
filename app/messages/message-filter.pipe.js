...
var MessageFilterPipe = (function () {
    ...
    MessageFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return filterBy ? value.filter(function (message) {
            return message.Label.toLocaleLowerCase().indexOf(filterBy) !== -1;
        }) : value;
    };
